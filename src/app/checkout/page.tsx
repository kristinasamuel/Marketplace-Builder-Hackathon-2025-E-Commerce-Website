...
const CheckoutPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-8 space-y-3">
      <h2 className="text-[49px] text-purple-500 font-bold  text-center">CHECKOUT</h2>
      ...
      <div className=" w-full max-w-lg">
        <Button
          ...
          className="w-full text-white text-[20px] rounded-lg bg-purple-500 hover:bg-purple-600 mt-5 shadow-md transition-colors"
        >
          Proceed To Checkout
        </Button>
      </div>
